...
public class FindGuitarTester {
    ...
    private static void initializeInventory(Inventory inventory) {
        ...
        inventory.addGuitar("11277", 3999.95, Builder.COLLINGS, "CJ", Type.ACOUSTIC,12,
        ...
        inventory.addGuitar("566-62", 8999.95, Builder.RYAN,
                "Cathedral", Type.ACOUSTIC,12,
                Wood.COCOBOLO, Wood.CEDAR);
        inventory.addGuitar("6 29584", 2100.95, Builder.PRS,
                "Dave Navarro Signature", Type.ELECTRIC,12,
