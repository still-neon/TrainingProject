package by.stn.java_exercises.modul_1.ex_20_need_fix;

public class LastSymbolTextCreator {
    private static final String TEXT = " what a hell, 123 is going on? I 45 don't  understand 7! ";//входные параметры
    ...
    private static String create(String txt) {
        ...
        for (int i = 0; i < txt.length(); i++) {//теже замечания
