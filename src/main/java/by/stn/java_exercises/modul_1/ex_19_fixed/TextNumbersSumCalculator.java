...
public class TextNumbersSumCalculator {
    private static final String TEXT = " what a hell, 123 is going on? I 45 don't  understand 7! ";//входные
    ...
    private static int calculate(String txt) {
        int numberStartIndex;//numStart, замечания прошлого задания, найти все числа и сложить(отделение)
